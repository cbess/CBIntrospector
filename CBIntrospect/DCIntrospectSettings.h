...
#define kDCIntrospectKeysNudgeViewLeft					@"a"		// nudges the selected view in given direction
#define kDCIntrospectKeysNudgeViewRight					@"d"		//
#define kDCIntrospectKeysNudgeViewUp                    @"w"		//
#define kDCIntrospectKeysNudgeViewDown					@"s"		//
#define kDCIntrospectKeysCenterInSuperview				@"5"		// centers the selected view in it's superview
#define kDCIntrospectKeysIncreaseWidth					@"D"		// increases/decreases the width/height of selected view
#define kDCIntrospectKeysDecreaseWidth					@"A"		//
#define kDCIntrospectKeysIncreaseHeight					@"W"		//
#define kDCIntrospectKeysDecreaseHeight					@"S"		//
...
#define kDCIntrospectKeysSetNeedsDisplay				    @"k"		// calls setNeedsDisplay on selected view
...
#define kDCIntrospectKeysLogAccessibilityProperties		@"q"		// logs accessibility info (useful for automated view tests - thanks to @samsoffes for the idea)
