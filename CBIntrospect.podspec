Pod::Spec.new do |s|
  s.name     = 'CBIntrospect'
  s.version  = '0.3.2'
  s.summary  = 'Introspect is a tool for iOS that aids in debugging user interfaces built with UIKit. It also communicates with View Introspector, the desktop companion app.'
